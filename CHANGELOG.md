...
- **iOS / tvOS 15.6 minimum**: Deployment target raised from iOS/tvOS 12.0 to 15.0. Apps targeting below 15.0 must remain on v1.x ([#32](https://github.com/mParticle/mparticle-apple-media-sdk/pull/32))
